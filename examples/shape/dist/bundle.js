(function () {
	...
	var VueTypes = {
	  ...
	  extend: function extend(props) {
	    ...
	    var descriptor = (_descriptor = {}, _descriptor[getter ? 'get' : 'value'] = function () {
	      return toType(name, type, validate);
	    }, _descriptor.enumerable = true, _descriptor.configurable = false, _descriptor);
	...
	new Vue({
	  ...
	  methods: {
	    addModel: function addModel() {
	      var newId = 'model-' + this.models.length;
