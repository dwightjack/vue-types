...
var hasOwn$1 = ObjProto.hasOwnProperty;
  ...
  Object.defineProperty(type, 'def', {
    value: function value(def) {
      ...
      if (!isFunction(def) && !validateType(this, def)) {
        warn$1(this._vueTypes_name + ' - invalid default value: "' + def + '"', def);
        return this;
      }
...
var validateType = function validateType(type, value) {
  ...
  if (hasOwn$1.call(typeToCheck, 'type') && typeToCheck.type !== null) {
    if (isArray(typeToCheck.type)) {
      valid = typeToCheck.type.some(function (type) {
        return validateType(type, value, true);
      });
      expectedType = typeToCheck.type.map(function (type) {
        return getType$1(type);
      }).join(' or ');
    } else {
  ...
  if (!valid) {
    silent === false && warn$1(namePrefix + 'value "' + value + '" should be of type "' + expectedType + '"');
    return false;
  }

  if (hasOwn$1.call(typeToCheck, 'validator') && isFunction(typeToCheck.validator)) {
    // swallow warn
    var oldWarn = void 0;
    if (silent) {
      oldWarn = warn$1;
    ...
    oldWarn && (warn$1 = oldWarn);

    if (!valid && silent === false) warn$1(namePrefix + 'custom validation failed');
    return valid;
  }
  return valid;
};
...

{
  ...
  warn$1 = hasConsole$1 ? function (msg) {
  ...
  custom: function custom(validatorFn) {
    ...
    return toType(validatorFn.name || '<<anonymous function>>', {
      validator: function validator() {
        ...
        if (!valid) warn$1(this._vueTypes_name + ' - ' + warnMsg);
        return valid;
      }
    });
  },
  ...
  oneOfType: function oneOfType(arr) {
    ...
    var typesStr = arr.map(function (type) {
      if (type && isArray(type.type)) {
        return type.type.map(getType$1);
      }
      return getType$1(type);
    ...
    return this.custom(function oneOfType(value) {
      ...
      if (!valid) warn$1('oneOfType - value type should be one of "' + typesStr + '"');
      return valid;
    });
  },
  arrayOf: function arrayOf(type) {
    return toType('arrayOf', {
      ...
      validator: function validator(values) {
        ...
        if (!valid) warn$1('arrayOf - value must be an array of "' + getType$1(type) + '"');
        return valid;
      }
    });
  },
  objectOf: function objectOf(type) {
    return toType('objectOf', {
      ...
      validator: function validator(obj) {
        ...
        if (!valid) warn$1('objectOf - value must be an object of "' + getType$1(type) + '"');
        return valid;
      }
    });
  },
    ...
    var type = toType('shape', {
      ...
      validator: function validator(value) {
        ...
        if (requiredKeys.length > 0 && requiredKeys.some(function (req) {
          ...
          warn$1('shape - at least one of required properties "' + requiredKeys.join('", "') + '" is not present');
          return false;
        }
        ...
        return valueKeys.every(function (key) {
          if (keys.indexOf(key) === -1) {
            ...
            warn$1('shape - object is missing "' + key + '" property');
            return false;
          }
          var type = obj[key];
